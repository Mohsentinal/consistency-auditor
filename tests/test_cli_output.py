...
def test_cli_prints_missing_and_extra(tmp_path: Path, capsys):
    ...
    live.write_text(
        ...
        "EURUSD,BUY,2026-01-02T09:00:00+00:00,1.1500\n",
        encoding="utf-8",
    )
    ...
    assert rc == 0
    assert "Missing in live" in out
    assert "Extra in live" in out